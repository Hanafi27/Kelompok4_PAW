...
<html lang="en">
    <head>
        ...
        <style>
            :root {
                ...
                --input-bg-light: #fff;
                --input-border-light: 1px solid #ced4da;
                ...
                --canvas-z-index: 1;
                --content-z-index: 2;
                --content-bg: rgba(255, 255, 255, 0.1); /* Semi-transparent overlay */
                --content-backdrop-filter: blur(10px);
            }

            [data-bs-theme="dark"] {
                --body-bg-dark: #212529;
                --box-bg-dark: #454d55; /* Darker background for box */
                ...
                --input-bg-dark: #5a6268;
                --input-border-dark: 1px solid #6c757d;
            ...
            body.register-page[data-bs-theme="dark"] {
            ...
            .register-box {
                ...
                position: relative; /* Ensure register-box is above canvas */
                z-index: var(--content-z-index); /* Use variable for z-index */
                 backdrop-filter: var(--content-backdrop-filter); /* Apply blur behind register box */
            }

            /* Apply dark mode styles to register box */
            body[data-bs-theme="dark"] .register-box {
            ...
            .card {
                 ...
                 box-shadow: none; /* Remove default card shadow inside box */
                 border-radius: 0; /* Remove default card radius inside box */
            ...
            /* Adjust link colors for dark mode */
             ...
             body[data-bs-theme="dark"] .text-center a {
                 color: var(--link-color-dark);
             }

            /* Adjust button styles for dark mode */
             .btn-primary {
                 background-color: var(--button-primary-background); /* Use link color for primary button */
                 border-color: var(--button-primary-background); /* Use link color */
                 color: var(--button-primary-color);
                 transition: all 0.3s ease;
             }
             body[data-bs-theme="dark"] .btn-primary {
                  background-color: var(--button-primary-background); /* Use dark mode link color */
    ...
    <body class="hold-transition register-page" data-bs-theme="light">
            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <a href="{{ route('login') }}" class="text-center mt-3">Already have an account? Log in</a>
                    </div>
